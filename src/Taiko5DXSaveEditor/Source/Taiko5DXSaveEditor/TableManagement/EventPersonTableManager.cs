...
namespace Taiko5DXSaveEditor.TableManagement
{
    ...
    /// イベント人物データテーブルの管理クラス
    /// </summary>
    public class EventPersonTableManager : GameDataTableManager
    {
        #region プロパティ
        /// <summary>
        /// テーブルの種類
        /// </summary>
        public override TableType TableType { get { return TableType.EventPerson; } }

        #endregion

        #region コンストラクタ
        /// <summary>
        /// イベント人物データテーブルの管理クラスのコンストラクタ
        /// </summary>
        /// <param name="gameDataTable">管理対象のテーブル</param>
        /// <param name="gameData">表示対象のゲームデータ</param>
        public EventPersonTableManager(DataGridView gameDataTable, GameData gameData)
        ...
        public override void InitializeTable()
        {
            ...
            // データ追加
            int n = GameData.NumOfEventPerson;
            _GameDataTable.Rows.Add(n);
            for (int i = 0; i < n; ++i)
            {
                int index = GameData.NumOfBusho + GameData.NumOfGeneralPurpose + i;
